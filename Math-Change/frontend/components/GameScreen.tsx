    ...
    <div className="w-full flex flex-col items-center justify-center space-y-4 animate-fade-in-up">
      ...
      <div className="w-full max-w-4xl flex justify-between items-center px-4">
        ...
        >
         ...
         {/* Header Info */}
        <div className="flex space-x-6 text-gray-400 text-sm font-semibold uppercase tracking-wider">
            <span>Nivel {attempt + 1}/{TOTAL_QUESTIONS}</span>
            <span className={timeLeft <= 3 ? "text-red-400 animate-pulse" : ""}>
                {timeLeft}s
            </span>
        </div>
      </div>
